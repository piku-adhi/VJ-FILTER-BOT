...
PICS = (environ.get('PICS', 'https://graph.org/file/332ccd03b44770a305559.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/332ccd03b44770a305559.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://graph.org/file/332ccd03b44770a305559.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://te.legra.ph/file/15c1ad448dfe472a5cbb8.jpg")

# Admins, Channels & Users
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002156634770'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001510999873') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', 'MalluTorentzTG')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://geniuscolorlab:A5kE4GB1I3kHxxuV@cluster0.hgdlor2.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
MSG_ALRT = environ.get('MSG_ALRT', 'made with ❤️ by @mallutorentztg')
