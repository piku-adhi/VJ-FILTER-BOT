...
async def start(client, message):
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        try:
            ...
            return
        btn = [[
            InlineKeyboardButton("💢 𝙹𝚘𝚒𝚗 𝙾𝚞𝚛 𝙲𝚑𝚊𝚗𝚗𝚎𝚕 💢", url=invite_link.invite_link)
        ]]
            ...
            try:
                if STREAM_MODE == True:
                    ...
                    await log_msg.reply_text(
                        ...
                        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('❤️‍🔥 ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴀᴅɪᴛʜʏᴀɴ ᴇᴅᴀɴᴀᴅᴜ💻', url='http://t.me/mrdevilmater')]])  # web stream Link
                    )
                if STREAM_MODE == True:
                    button = [[
                        InlineKeyboardButton('💢 𝙹𝚘𝚒𝚗 𝙾𝚞𝚛 𝙲𝚑𝚊𝚗𝚗𝚎𝚕 💢', url=CHNL_LNK)
                    ]]
                else:
                    button = [[
                        InlineKeyboardButton('💢 𝙹𝚘𝚒𝚗 𝙾𝚞𝚛 𝙲𝚑𝚊𝚗𝚗𝚎𝚕 💢', url=CHNL_LNK)
